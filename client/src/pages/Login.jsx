  ...
  return (
    <div className="min-h-screen flex bg-slate-900">
      ...
      <div className="w-full lg:w-1/2 flex">
        <div className="w-full p-6 shadow-xl bg-gradient-to-br from-slate-800 via-blue-900 to-slate-800">
          ...
          <form onSubmit={handleLogin} className="mt-6 space-y-4 text-slate-200">
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-3 px-4 h-10 bg-slate-700/50 text-white border border-slate-600 rounded-lg"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full mt-10 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700"
            >
              Sign in
            </button>
          </form>
